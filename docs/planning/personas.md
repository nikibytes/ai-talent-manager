...
version: 1
approved_by: human
approved_at: 2026-08-22T20:02:53Z
---
...
- Receive concise EOD reports covering applications, queued opportunities, recruiter activity, rejected/almost-there jobs, and pending approvals.

### Key Behaviors

- Reviews the agent dashboard and/or EOD email once or twice daily.
- Configures the daily application target and matching thresholds.
- Approves applications before submission during MVP.
- Approves recruiter messages before sending during MVP.
- Approves AI-generated LinkedIn posts before publishing.
...
- Can approve or reject consequential external actions.
...
- Prepare applications for approval.
...
- Must not submit applications, send consequential recruiter messages, or publish LinkedIn content without required human approval during MVP.
...
- Messages are human-approved before dispatch during MVP.
...
- **USER DECISION**: Daily application volume is configurable by the candidate.
...
- **USER DECISION**: AI-generated LinkedIn content is human-approved before publication during MVP.
- **USER DECISION**: Critical external actions require human approval during MVP.
